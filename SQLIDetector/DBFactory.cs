...
{
    /// <summary>
    /// The DatabaseFactory class is intended to encapsulate high performance, scalable best practices for 
    ...
    public sealed class DBFactory
    {
        ...
        // instances from being created with "new DatabaseFactory()"
        private DBFactory() { }
        ...
        public static void CreateErrorLog(string ErrorDescription)
        {
            try
            {
                SqlCommand dbCommand = GetStoredProcCommand("CreateErrorLog");
                AddParameter(dbCommand, "@ErrorDescription", SqlDbType.Text, ErrorDescription);
        ...
        /// </remarks>
        /// <param name="connection">A valid SQL Command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        ...
        /// <summary>
        /// This enum is used to indicate whether the connection was provided by the caller, or created by DatabaseFactory, so that
        ...
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">An array of SqlParameters to be associated with the command or 'null' if no parameters are required</param>
        /// <param name="connectionOwnership">Indicates whether the connection parameter was provided by the caller, or created by DatabaseFactory</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  SqlCommand command = CreateCommand(conn, "AddClient", "ClientID", "ClientName");
        /// </remarks>
